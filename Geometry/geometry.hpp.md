...
data:
  ...
  bundledCode: "#line 2 \"Geometry/geometry.hpp\"\n\r\nusing T=double;\r\nconst T\
    \ eps=1e-12;\r\nusing P=complex<T>;\r\nusing Poly=vector<P>;\r\n#define X real()\r\
    \n#define Y imag()\r\ninline bool eq(const T& a,const T& b){\r\n    return fabs(a-b)<eps;\r\
    \n}\r\ninline bool cmp(const P& a,const P& b){\r\n    return (eq(a.X,b.X)?a.Y<b.Y:a.X<b.X);\r\
    \n}\r\nstruct Line{\r\n    P a,b;\r\n    Line(){}\r\n    Line(P _a,P _b):a(_a),b(_b){}\r\
    \n    Line(T A,T B,T C){\r\n        if(eq(A,.0)){\r\n            a=P(0,C/B),b=P(1/C/B);\r\
    \n        }\r\n        else if(eq(B,.0)){\r\n            a=P(C/A,0),b=P(C/A,1);\r\
    \n        }\r\n        else{\r\n            a=P(0,C/B),b=P(C/A,0);\r\n       \
    \ }\r\n    }\r\n};\r\nstruct Segment:Line{\r\n    Segment(){}\r\n    Segment(P\
    \ _a,P _b):Line(_a,_b){}\r\n};\r\nstruct Circle{\r\n    P p; T r;\r\n    Circle(){}\r\
    ...
    \ a,const P& b){\r\n    P c=Projection(a,b);\r\n    return abs(c-b);\r\n}\r\n\
    T Dist(const Segment& a,const P& b){\r\n    if(dot(a.b-a.a,b-a.a)<eps)return abs(b-a.a);\r\
    \n    if(dot(a.a-a.b,b-a.b)<eps)return abs(b-a.b);\r\n    return abs(cross(a.b-a.a,b-a.a))/abs(a.b-a.a);\r\
    ...
    \n    if(a.r-abs(rc)<eps)rs=0;\r\n    P e=unit(b.p-a.p);\r\n    res.push_back(a.p+rc*e+rs*e*P(0,1));\r\
    ...
    \ Circle& c,const P& p1,const P& p2){\r\n        P va=c.p-p1,vb=c.p-p2;\r\n  \
