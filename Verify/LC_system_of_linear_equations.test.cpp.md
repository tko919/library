...
data:
  ...
  bundledCode: "#line 1 \"Verify/LC_system_of_linear_equations.test.cpp\"\n#define\
    ...
    #line 8 \"Verify/LC_system_of_linear_equations.test.cpp\"\n\r\nusing Fp = fp<998244353>;\r\
    \n\r\nint main() {\r\n    int n, m;\r\n    cin >> n >> m;\r\n    Matrix<Fp> a(n,\
    \ m);\r\n    vector<Fp> b(n);\r\n    rep(i, 0, n) rep(j, 0, m) cin >> a[i][j];\r\
    \n    rep(i, 0, n) cin >> b[i];\r\n\r\n    auto [ret, basis] = LinearEquation(a,\
    \ b);\r\n    if (ret.empty()) {\r\n        puts(\"-1\");\r\n        return 0;\r\
    \n    }\r\n    cout << basis.h << '\\n';\r\n    rep(i, 0, m) cout << ret[i] <<\
    \ (i == m - 1 ? '\\n' : ' ');\r\n    rep(i, 0, basis.h) {\r\n        rep(j, 0,\
    \ m) cout << basis[i][j] << (j == m - 1 ? '\\n' : ' ');\r\n    }\r\n    return\
    \ 0;\r\n}\n"
  ...
  requiredBy: []
  timestamp: '2024-04-26 04:43:32+09:00'
