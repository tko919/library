...
data:
  ...
  bundledCode: "#line 1 \"Verify/YUKI_2097.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/2097\"\
    ...
    \ Fast IO\r\n */\n#line 5 \"Verify/YUKI_2097.test.cpp\"\n\n#line 2 \"Math/modint.hpp\"\
    ...
    \ mod)\r\n */\n#line 9 \"Verify/YUKI_2097.test.cpp\"\nusing Fp = fp<998244353>;\n\
    NTT<Fp> ntt;\ntemplate <> void Poly<Fp>::NTT(vector<Fp> &v, bool inv) const {\n\
    \    return ntt.ntt(v, inv);\n}\n\n#line 2 \"FPS/prodoffrkx.hpp\"\n\ntemplate<typename\
    \ T>Poly<T> ProdOf_f_rk_x(Poly<T>& f,T r,int m){ // f(x)f(rx)...f(r^{m-1}x)\n\
    \    assert(f[0]==1);\n    T pwr=1,rm=T(r).pow(m),pwrm=1;\n    auto g=f.log();\n\
    \    rep(i,1,g.size()){\n        pwr*=r;\n        pwrm*=rm;\n        if(pwr==1)g[i]*=m;\n\
    \        else g[i]*=(pwrm-1)/(pwr-1);\n    }\n    return g.exp();\n}\n\n/**\n\
    \ * @brief $\\Pi_{k=0}^{m-1} f(r^kx)$\n*/\n#line 16 \"Verify/YUKI_2097.test.cpp\"\
    \n\nint main() {\n    int n, m, L;\n    read(n, m, L);\n\n    Fp two = Fp(2).pow(n).inv();\n\
    \    Poly<Fp> f(L + 1);\n    f[0] = 1;\n    rep(i, 1, L + 1) f[i] = Fact<Fp>(i,\
