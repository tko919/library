...
data:
  ...
  bundledCode: "#line 1 \"Verify/LC_stirling_number_of_the_second_kind.test.cpp\"\n\
    #define PROBLEM                                                              \
    \  \\\n    \"https://judge.yosupo.jp/problem/stirling_number_of_the_second_kind\"\
    ...
    \ : \"Impossible\");\r\n}\r\ninline void POSSIBLE(bool i = true) {\r\n    print(i\
    \ ? \"POSSIBLE\" : \"IMPOSSIBLE\");\r\n}\r\n\r\n/**\r\n * @brief Fast IO\r\n */\n\
    #line 6 \"Verify/LC_stirling_number_of_the_second_kind.test.cpp\"\n\n#line 2 \"\
    ...
    \ <typename T> vector<T> Bernoulli(int n) {\n    Poly<T> f(n + 1);\n    rep(i,\
    \ 0, n + 1) f[i] = Fact<T>(i + 1, 1);\n    f = f.inv();\n    rep(i, 0, n + 1)\
    \ f[i] *= Fact<T>(i);\n    return f;\n}\n\ntemplate <typename T> vector<T> Partition(int\
    \ n) {\n    Poly<T> f(n + 1);\n    f[0] = 1;\n    rep(k, 1, n + 1) {\n       \
    \ if (1LL * k * (3 * k + 1) / 2 <= n)\n            f[1LL * k * (3 * k + 1) / 2]\
    \ += (k & 1 ? -1 : 1);\n        if (1LL * k * (3 * k - 1) / 2 <= n)\n        \
...
layout: document
redirect_from:
- /verify/Verify/LC_stirling_number_of_the_second_kind.test.cpp
- /verify/Verify/LC_stirling_number_of_the_second_kind.test.cpp.html
